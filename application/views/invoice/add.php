...
/*
                                  ...
                                  if ($x > 1)
                                  {
                                    ...
                                    for($i=0 ; $i<$x-1; $i++)
                                    {
                                        if($quotation_products[$i]['maid_name'] == $quotation_products[$i+1]['maid_name'])
                                       {?>
                                  ...
                                  <form id="detail-form">
                                    <div class="col-md-3">
                                        <select class="form-control input-sm" name="product_id" id="product-id">
                                            <option value="<?php echo $maid['maid_id']?>" selected><?php echo $maid['maid_name']?></option>
