...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
          ...
          <li class="active"><?=$action=='add'?'New':'Edit'?> Invoice Contract</li>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-12 order-header">Order Contract</div>
                        <div class="clearfix margin-sm-b"></div>
                        <div class="col-sm-12">
                                  ...
                                  if ($x > 1)
                                  {
                                    ...
                                    for($i=0 ; $i<$x-1; $i++)
                                    {
                                       ...
                                       <?php }
                                          ...
                                          $classname = $row . ' id-'.$quotation_product['invoice_contract_id']; 
                                ?>
                                        <div class="<?= $classname; ?>"> 
                                            <div class='col-md-3'><?= $quotation_product['contract_name']; ?></div>
                                        ...
                                        <select class="form-control input-sm" name="product_id" id="product-id">
                                            ...
                                            <?php if($products != '') { ?>
                                                <?php foreach($products as $product) {  
                                                    echo "<option value='". $product['contract_id'] . "' >" . $product['contract_name'] . "</option>";
                                                } ?>
                                            <?php } ?>
                                        </select>   
                                    </div>
...
<?php if ( $action == "add" ) { ?>
  <script src="<?= base_url();?>public/js/quotation-contract-add.js"></script>
<?php } elseif ( $action == "edit" ) { ?>
  <script src="<?= base_url();?>public/js/quotation-contract-edit.js"></script>
<?php } ?>