...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
          ...
          <li class="active"><?=$action=='add'?'New':'Edit'?> Invoice Insurance</li>
...
<div class="row">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-12 order-header">Order Insurance</div>
                        <div class="clearfix margin-sm-b"></div>
                        <div class="col-sm-12">
  ...
  /*                                              $x = count($quotation_products);
                                  ...
                                  if ($x > 1)
                                  {
                                    ...
                                    for($i=0 ; $i<$x-1; $i++)
                                    {
                                        if($quotation_products[$i]['package_name'] == $quotation_products[$i+1]['package_name'])
                                       {?>
                                       ...
                                       <?php }
                                          ...
                                          $classname = $row . ' id-'.$quotation_product['invoice_insurance_id']; 
                                ?>
                                        <div class="<?= $classname; ?>"> 
                                            <div class='col-md-3'><?= $quotation_product['insurance_name']; ?></div>
                                        ...
                                        <select class="form-control input-sm" name="product_id" id="product-id">
                                            ...
                                            <?php if($products != '') { ?>
                                                <?php foreach($products as $product) {  
                                                    echo "<option value='". $product['insurance_id'] . "' >" . $product['insurance_name'] . "</option>";
                                                } ?>
                                            <?php } ?>
                                        </select>   
                                    </div>
...
<?php if ( $action == "add" ) { ?>
  <script src="<?= base_url();?>public/js/quotation-insurance-add.js"></script>
<?php } elseif ( $action == "edit" ) { ?>
  <script src="<?= base_url();?>public/js/quotation-insurance-edit.js"></script>
<?php } ?>