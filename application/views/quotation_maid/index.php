        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    ...
                    <a class="btn btn-default btn-xs" id="btn-export" href="<?=base_url()?>quotation_maid/export_quotation"><i class="fa fa-file-excel-o ico-btn"></i> Export</a>
                    <div class="btn-group">
                        <a class="btn btn-default btn-xs" href="<?=base_url()?>quotation_maid/add"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
            </div>
            <div class="panel-body">
                <form role="form"  action="<?=base_url()?>quotation_maid">
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="form-group">
                                <input class="form-control input-sm" name="quotation_no" placeholder="Quotation No." value="<?=isset($_GET['quotation_no'])?$_GET['quotation_no']:''?>">
                            </div>
                        </div>
                        ...
                        <tbody>
                            ...
                            <?php if (!empty($quotations)): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <a title="View" href="<?=base_url()?>quotation_maid/view/<?=$quotation->quotation_id?>"><i class="fa fa-search"></i></a>&nbsp
                                        <?php //if ($quotation->is_close==0): ?>                       
                                            <a title="Edit" href="<?=base_url()?>quotation_maid/edit/<?=$quotation->quotation_id?>"><i class="fa fa-pencil-square-o"></i></a>&nbsp
                                            <a title="Delete" href="<?=base_url()?>quotation_maid/delete/<?=$quotation->quotation_id?>" onclick="return confirm_delete()" ><i class="fa fa-trash-o"></i></a>
                                        <?php// endif ?>
                                    </td>
                                </tr>
                                <?php endforeach?>
