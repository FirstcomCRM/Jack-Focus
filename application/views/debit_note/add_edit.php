...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><?=$action=='add'?'New':'Edit'?> Debit Note</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
          ...
          <li><a href="<?=base_url()?>debit">Debit Note</a></li>
          <li class="active"><?=$action=='add'?'New':'Edit'?> Debit Note</li>
            <div class="pull-right">
                <div class="btn-group">
                    <a class="btn btn-default btn-xs" href="<?=base_url()?>debit"><i class="fa fa-arrow-circle-o-left"></i> Back</a>
                </div>
            </div>
        </ol>
    </div>
                ...
                <div class="row">
                    <form role="form" method="post">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-4"><label>DN No</label></div>
                                    <div class="col-lg-6 required-field-block">
                                        <input class="form-control input-sm" name="dn_no" value="<?=isset($dn_no)?$dn_no:''?>" readonly>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-4"><label>Date</label></div>
                                        <div class="col-lg-6 required-field-block">
                                            <input class="form-control input-sm" id="dn_date" name="dn_date" value="<?=isset($_POST['dn_date'])?$_POST['dn_date']:date('d-m-Y')?>">
                                            <div class="required-icon">
                                            <div class="text">*</div>
                                        </div>
                                        </div>
