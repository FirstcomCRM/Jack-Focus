<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><?=$action=='add'?'New':'Edit'?> Quotation</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
          ...
          <li class="active"><?=$action=='add'?'New':'Edit'?> Quotation</li>
            <div class="pull-right">
                <div class="btn-group">
                    <a class="btn btn-default btn-xs" href="<?=base_url()?>quotation"><i class="fa fa-arrow-circle-o-left"></i> Back</a>
                </div>
            </div>
        </ol>
    </div>
...
<?php if ($action=='edit'): ?>
    <div class="row">
        <div class="col-lg-12 text-right">
            <a class="btn btn-default btn-sm" href="<?=base_url()?>quotation/view/<?=$quotation['quotation_id']?>"><i class="fa fa-search"></i> View</a>
        </div>
    </div>
<br>
<?php endif ?>
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control input-sm" name="customer_id" id="customer-id">
                                        <?php if ($customers!=''): ?>
                                            ...
                                            <option value="<?=$customer['customer_id']?>" <?=isset($_POST['customer_id'])&&$_POST['customer_id']==$customer['customer_id']?"selected":(isset($quotation['customer_id'])&&$quotation['customer_id']==$customer['customer_id']?'selected':'')?>><?=$customer['company_name']?></option>
                                            <?php endforeach ?>
                                        <?php endif ?>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control input-sm" name="sale_person_id" id="sale_person_id">
                                        <?php if ($sale_persons!=''): ?>
                                            <option value=""> - Please Select Sale person - </option>
                                            <?php foreach ($sale_persons as $sale_person): ?>
                                            <option value="<?=$sale_person['sale_person_id']?>" <?=isset($_POST['sale_person_id'])&&$_POST['sale_person_id']==$sale_person['sale_person_id']?"selected":(isset($quotation['sale_person_id'])&&$quotation['sale_person_id']==$sale_person['sale_person_id']?'selected':'')?>><?=$sale_person['name']?></option>
                                            <?php endforeach ?>
                                        <?php endif ?>
                                    </select>
                                </div>
                            ...
                            <div class="row-fluid grid-area product-grid"> 
                                ...
                                ?>
                                        <div class="<?= $classname; ?>"> 
                                            ...
                                            <div class='col-md-1'><?= $quotation_product['quantity']; ?></div>
