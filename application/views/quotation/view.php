...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">View Quotation</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row">
...
<div class="row">
    <div class="col-lg-12 text-right">
        <a class="btn btn-default btn-sm" href="<?=base_url()?>quotation/print_preview/<?=$quotation['quotation_id']?>" target="_blank"><i class="fa fa-print"></i> Print</a>
        <?php if ($quotation['is_close']==0): ?>
            <a class="btn btn-default btn-sm" href="<?=base_url()?>invoice/add/<?=$quotation['quotation_id']?>" onclick="return confirm_produce_invoice()"><i class="fa fa-file-text-o"></i> Generate Invoice</a>
            <a class="btn btn-default btn-sm" href="<?=base_url()?>quotation/edit/<?=$quotation['quotation_id']?>"><i class="fa fa-pencil-square-o"></i> Edit</a>
        <?php endif ?>
    </div>
</div>
<br>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <a href="#" data-toggle="modal"data-target="#cusomter-info" value="<?=$quotation['customer_id']?>"><?=$quotation['company_name']?></a>
                                </div>
