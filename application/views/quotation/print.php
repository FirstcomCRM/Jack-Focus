<div class="buttons">
    <button class="btn btn-info btn-sm" onclick="window.print('<?=base_url()?>quotation/print_preview/<?=$quotation['quotation_id']?>')" type="button">Print</button>
            	...
            	<div class="page-info">
            		...
            		<div class="row">
            			<div class="col-mid-3_7">
            				...
            				<div class="hp">
                                <div class="font-bold col-left-3">Handphone:</div>&nbsp<div class="font-normal"><?=$customer_info['hp']?></div>
                            </div>
            			</div>
            			<div class="col-mid-3">
                            <div class="phone">
