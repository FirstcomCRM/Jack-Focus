                ...
                <div class="row">
                    <form role="form" id="JackForm"  method="post">
                        ...
                        <!--<ul class="nav nav-tabs">
                          ...
                          <li><a data-toggle="tab" href="#medical_history">Medical History</a></li>
                          <li><a data-toggle="tab" href="#skills">Skills</a></li>
                          <li><a data-toggle="tab" href="#employment">Employment History</a></li>
                        </ul>-->
                        ...
                        <!-- <div class="tab-content col-lg-12">
                          <div id="personal_info" class="tab-pane fade in active"> -->
                            <h3>Personal Information</h3>
                             <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-1"><label>Ref No</label></div>
                             ...
                             <div class="form-group">
                                <div class="row">
                                        <div class="col-lg-1"><label>Supplier</label></div>
                                        <div class="col-lg-5">
                                    ...
                                    <div class="col-lg-1"><label>Status</label></div>
                                    <div class="col-lg-5">
                            ...
                            <div class="form-group">
                                <div class="row">
                                     <div class="col-lg-1"><label>Branch</label></div>
                                    <div class="col-lg-5">
                                ...
                                <div class="col-lg-1"><label>Staff</label></div>
                                    <div class="col-lg-5">
                            ...
                            <!--<div class="form-group">
                                <div class="row">
                                    <div class="col-lg-1 "><label>Employer</label></div>
                                    <div class="col-lg-5 -field-block">
                                    <input class="form-control input-sm" name="maid_employer" value="<?=isset($_POST['maid_employer'])?$_POST['maid_employer']:(isset($maid['maid_employer'])?$maid['maid_employer']:'')?>">
                                    </div>
                             ...
                             <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-1"><label>Passport No.</label></div>
                                    <div class="col-lg-5 -field-block"><input class="form-control input-sm" name="maid_passport" value="<?=isset($_POST['maid_passport'])?$_POST['maid_passport']:(isset($maid['maid_passport'])?$maid['maid_passport']:'')?>" >
                                    </div>

                                    <div class="col-lg-1"><label>21 days</label></div>
                            ...
                            <h4><b>( A )PROFILE OF FDW </b></h4>
                            <h4><b>A1 Personal Information  </b></h4>

                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-1"><label>1. Name</label></div>
                                    <div class="col-lg-5 -field-block"><input class="form-control input-sm" name="maid_name" value="<?=isset($_POST['maid_name'])?$_POST['maid_name']:(isset($maid['maid_name'])?$maid['maid_name']:'')?>" >
                                    </div>

                                    <div class="col-lg-1"><label>2. Date of birth</label></div>
                                        <div class="input-group date col-lg-4" data-provide="datepicker">
                             ...
                             <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-1"><label>3.a Height</label></div>
                                    <div class="col-lg-5 -field-block"><input class="form-control input-sm" name="maid_height" value="<?=isset($_POST['maid_height'])?$_POST['maid_height']:(isset($maid['maid_height'])?$maid['maid_height']:'')?>" >
                                    </div>
                                    

                                    <div class="col-lg-1"><label>3.b Weight</label></div>
                                    <div class="col-lg-5 -field-block"><input class="form-control input-sm" name="maid_weight" value="<?=isset($_POST['maid_weight'])?$_POST['maid_weight']:(isset($maid['maid_weight'])?$maid['maid_weight']:'')?>" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4"><label>4. Place of birth</label></div>
                                    <div class="col-lg-8 -field-block"><input class="form-control input-sm" name="maid_place_birth" value="<?=isset($_POST['maid_place_birth'])?$_POST['maid_place_birth']:(isset($maid['maid_place_birth'])?$maid['maid_place_birth']:'')?>" >
                                    </div>
                             ...
                             <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4"><label>5. Nationality</label></div>
                                    <div class="col-lg-8">
                             ...
                             <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4"><label>6. Residential address in home country</label></div>
                                    <div class="col-lg-8 -field-block"><input class="form-control input-sm" name="maid_res_home" value="<?=isset($_POST['maid_res_home'])?$_POST['maid_res_home']:(isset($maid['maid_res_home'])?$maid['maid_res_home']:'')?>" ></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4"><label>7. Name of port / airport to be repatriated to </label></div>
                                    <div class="col-lg-8 -field-block"><input class="form-control input-sm" name="maid_port" value="<?=isset($_POST['maid_port'])?$_POST['maid_port']:(isset($maid['maid_port'])?$maid['maid_port']:'')?>" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                     ...
                                     <div class="col-lg-4"><label>8. Contact number in home country </label></div>
                                     <div class="col-lg-8 -field-block"><input class="form-control input-sm" name="maid_contact_home" value="<?=isset($_POST['maid_contact_home'])?$_POST['maid_contact_home']:(isset($maid['maid_contact_home'])?$maid['maid_contact_home']:'')?>" ></div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4"><label>9. Religion</label></div>
                                    <div class="col-lg-8 -field-block"><input class="form-control input-sm" name="maid_religion" value="<?=isset($_POST['maid_religion'])?$_POST['maid_religion']:(isset($maid['maid_religion'])?$maid['maid_religion']:'')?>" >
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4"><label>10. Education Level</label></div>
                                    <div class="col-lg-8 -field-block"><input class="form-control input-sm" name="maid_educ" value="<?=isset($_POST['maid_educ'])?$_POST['maid_educ']:(isset($maid['maid_educ'])?$maid['maid_educ']:'')?>" >
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                      ...
                                      <div class="col-lg-3"><label>11. Number of siblings </label></div>
                                    <div class="col-lg-3 -field-block"><input class="form-control input-sm" name="maid_sibs" value="<?=isset($_POST['maid_sibs'])?$_POST['maid_sibs']:(isset($maid['maid_sibs'])?$maid['maid_sibs']:'')?>" >
                                    </div>
                                    

                                      <div class="col-lg-3"><label>12. Marital status </label></div>
                                    <div class="col-lg-3 -field-block"><input class="form-control input-sm" name="maid_mar_status" value="<?=isset($_POST['maid_mar_status'])?$_POST['maid_mar_status']:(isset($maid['maid_mar_status'])?$maid['maid_mar_status']:'')?>" >
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3"><label>13. Number of children </label></div>
                                    <div class="col-lg-3 -field-block"><input class="form-control input-sm" name="maid_children" value="<?=isset($_POST['maid_children'])?$_POST['maid_children']:(isset($maid['maid_children'])?$maid['maid_children']:'')?>" >
                                    </div>
                                    

                                      <div class="col-lg-3"><label>-Age(s) of children (if any): </label></div>
                                    <div class="col-lg-3 -field-block"><input class="form-control input-sm" name="maid_children_age" value="<?=isset($_POST['maid_children_age'])?$_POST['maid_children_age']:(isset($maid['maid_children_age'])?$maid['maid_children_age']:'')?>" >
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 -field-block"><input class="form-control input-sm" name="maid_children" value="<?=isset($_POST['maid_children'])?$_POST['maid_children']:(isset($maid['maid_children'])?$maid['maid_children']:'')?>" >
                                      ...
                                      <div class="col-lg-3"><label>-Age(s) of children (if any): </label></div>
                                    <div class="col-lg-3"><input class="form-control input-sm" name="maid_children_age" value="<?=isset($_POST['maid_children_age'])?$_POST['maid_children_age']:(isset($maid['maid_children_age'])?$maid['maid_children_age']:'')?>" >
                                    </div>
                                </div>
                          ...
                          <!-- </div>end 1st tab  -->
                          <!-- <div id="medical_history" class="tab-pane fade"> -->
                            <h3>Medical History</h3>
                             <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-4"><label>14. Allergies (if any): </label></div>
                                    <div class="col-lg-8"><input class="form-control input-sm" name="maid_allergies" value="<?=isset($_POST['maid_allergies'])?$_POST['maid_allergies']:(isset($maid['maid_allergies'])?$maid['maid_allergies']:'')?>" >
                                    </div>
                                </div>
                            </div>


                           <h4>15. Past and existing illnesses (including chronic ailments and illnesses requiring medication)  </h4>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-4"><label>16. Physical disability </label></div>
                                    <div class="col-lg-8 -field-block"><input class="form-control input-sm" name="maid_physical_d" value="<?=isset($_POST['maid_physical_d'])?$_POST['maid_physical_d']:(isset($maid['maid_physical_d'])?$maid['maid_physical_d']:'')?>" >
                                    </div>
                                </div>   
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-4"><label>17. Dietary restriction </label></div>
                                    <div class="col-lg-8 -field-block"><input class="form-control input-sm" name="maid_dietary_res" value="<?=isset($_POST['maid_dietary_res'])?$_POST['maid_dietary_res']:(isset($maid['maid_dietary_res'])?$maid['maid_dietary_res']:'')?>" >
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4"><label>Food handling preferences:  </label></div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-4"><label>Problems Handling other food </label></div>
                                    <div class="col-lg-8 -field-block"><input class="form-control input-sm" name="maid_handling_others" value="<?=isset($_POST['maid_handling_others'])?$_POST['maid_handling_others']:(isset($maid['maid_handling_others'])?$maid['maid_handling_others']:'')?>" >
                                    </div>
                                </div>    
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                     <div class="col-lg-4"><label>19. Preference for rest day: restday per month</label></div>
                                    <div class="col-lg-8 -field-block"><input class="form-control input-sm" name="maid_rest" value="<?=isset($_POST['maid_rest'])?$_POST['maid_rest']:(isset($maid['maid_rest'])?$maid['maid_rest']:'')?>" ></div>
                                </div>    
                            </div>

                            <div class="form-group">
                                <div class="row">
                                      <div class="col-lg-4"><label>20. Any Other remarks </label></div>
                                    <div class="col-lg-8 -field-block"><input class="form-control input-sm" name="maid_remarks" value="<?=isset($_POST['maid_remarks'])?$_POST['maid_remarks']:(isset($maid['maid_remarks'])?$maid['maid_remarks']:'')?>" >
                                    </div>
                                </div>    
                            </div>
                         ...
                         <!--  </div>end 2nd tab  -->
                          ...
                          <!--  </div>  <!--  for this <form role="form" id="JackForm"  method="post"> -->
                      ...
                      <br>
                          <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <button type="submit" onclick="return confirm_submit()" class="btn btn-primary btn-block"><?=$action=='add'?'Create':'Update'?></button>
                                    </div>
                                </div>
                            </div>
