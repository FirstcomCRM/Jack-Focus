        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    ...
                    <div class="btn-group">
                        <a class="btn btn-default btn-xs" href="<?=base_url()?>invoice/add"><i class="fa fa-plus"></i> Add FDW</a>
                    </div>
                    <div class="btn-group">
                        <a class="btn btn-default btn-xs" href="<?=base_url()?>invoice/add_package"><i class="fa fa-plus"></i> Add Package</a>
                    </div>
                    <div class="btn-group">
                        <a class="btn btn-default btn-xs" href="<?=base_url()?>invoice/add"><i class="fa fa-plus"></i> Add Insurance</a>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <?php if (!empty($quotations)): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="<?=$quotation->is_paid==1?'text-success':($quotation->is_paid==0?'text-danger':'text-warning')?>"><?=$quotation->is_paid==1?'Fully Paid':($quotation->is_paid==0?'Unpaid':'Partial Paid')?>
                                    </td>
                                    <!--<td class="<?=$quotation->is_close==1?'text-success':'text-danger'?>"><?=$quotation->is_close==1?'Closed':'Pending'?></td>-->

                                    <td>
                                       <a title="View" href="<?=base_url()?>invoice/view/<?=$quotation->quotation_id?>"><i class="fa fa-search"></i></a>&nbsp
                                        <?php //if ($quotation->is_close==0): ?>                       
                                            <a title="Edit" href="<?=base_url()?>invoice/edit/<?=$quotation->quotation_id?>"><i class="fa fa-pencil-square-o"></i></a>&nbsp
